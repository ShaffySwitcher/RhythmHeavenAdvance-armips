# Disclaimer
This patch has been ported to the decompilation of *Rhythm Tengoku* allowing for new functionality! Check out the new project which is still maintained [here](https://github.com/RHAdvance/RhythmHeavenAdvance)!
